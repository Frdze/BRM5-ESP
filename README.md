...
-   Color changes apply instantly to all active visual features.
-   Opacity control only affects fill-based highlights.
-   Crosshair visibility follows the active visual mode automatically.
